  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-gray-100">
      <nav className="max-w-7xl mx-auto px-5 lg:px-8 flex items-center justify-between h-20">
        ...
        {/* Desktop nav */}
        <div className="hidden lg:flex items-center gap-7 font-display uppercase text-sm tracking-wide font-medium text-navy">
        ...
        <Link
          href="/quote"
          className="hidden lg:inline-flex items-center px-6 py-3 rounded-lg bg-navy text-white font-display uppercase text-sm tracking-wide font-semibold hover:bg-navy-dark transition-colors"
        >
          Get a Quote
        </Link>
